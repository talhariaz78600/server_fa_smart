...
router.post('/add-product', async (req, res) => {
    try {
        const { productName, productDescription, price, CompletionDate, Rating, categoryType, projectType, projectUrl } = req.body;

        if (!productName || !productDescription || !price || !CompletionDate || !categoryType || !projectType) {
...
router.put('/:productId/edit-product', async (req, res) => {
    try {
        ...
        existingproduct.CompletionDate = CompletionDate;
